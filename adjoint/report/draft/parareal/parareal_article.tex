...
\begin{align}
x_0 &=y_0 \\
x_1 &=y_1 + G_{\Delta T}(y_0) \\
x_2 &=y_2 + G_{\Delta T}(y_1 + G_{\Delta T}(y_0)) \\
x_3 &=y_3 + G_{\Delta T}(y_2 + G_{\Delta T}(y_1 + G_{\Delta T}(y_0))) 
\end{align}
...
\begin{align}
x_0 &=y_0 +G_{\Delta T}^*(y_1 + G_{\Delta T}^*(y_2 + G_{\Delta T}^*(y_ 3)))\\
x_1 &=y_1 + G_{\Delta T}^*(y_2 + G_{\Delta T}^*(y_ 3))\\
x_2 &=y_2 + G_{\Delta T}^*(y_ 3) \\
x_3 &=y_3 
\end{align}
\bibliography{ppaper}
