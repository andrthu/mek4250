\chapter{Discretization and MPI communication} \label{disc_chap}
...
\subsection{Numerical gradient} \ref{num_grad_sec1}
...
\subsection{Numerical gradient of the penalized example problem} \label{num_grad_sec2}
