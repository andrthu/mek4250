...
\subsection{Deriving adjoint for the example problem}
...
M^*\left( \begin{array}{c}
	...
	p_2(T_2)-p_1(T_2)\\
	\cdots \\
	p_{N-2}(T_{N-2})-p_{N-3}(T_{N-2}) \\
	-p_{N-2}(T_{N-2})
	\end{array} \right)
\end{align}
The last vector, can be recognised as the gradient of (\ref{virtual_func}) in its 2nd to $(N-1)$th indices.
\\
\\ 
