...
\cite{nocedal2006numerical}
\end{proof}
Even though quasi-Newton methods do not posses the quadratic convergence of the Newton method, superlinear convergence is still a lot better than the linear one for steepest decent.