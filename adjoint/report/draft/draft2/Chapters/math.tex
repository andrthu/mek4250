...
\left\{
   ...
   \right. \label{exs_E}
\end{align}
Before we derive the adjoint and gradient of the reduced version of the above problem, I want to return to the question of solvability. To achieve this, I will write up a general result from \cite{hinze2008optimization} about linear quadratic problems, which also includes problem (\ref{exs_J}-\ref{exs_E}).
\begin{theorem}
