...
E_u^*p = J_u
\end{align*}
As always, $E$ refers to the state equation, which in our case is Burgers equation(\ref{burger}). I will now write up the weak formulation of (\ref{burger}), since I will later use it to ssolve the equation, and :
\begin{align*}
