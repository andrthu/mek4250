    ...
    def parallel_adjoint_penalty_solver(self,u,N,m,mu):
        ...
        * m: Number of intervals we partition time in
        ...
        def penalty_grad(self,u,N,m,mu):
            ...
            grad = self.parallel_grad_J(u,p,float(self.T)/N)
...
def generate_problem(y0,yT,T,a):
    ...
    def parallel_J(u,y,yT,T,mu,N,comm):
        m = comm.Get_size()
        rank = comm.Get_rank()
    ...
    def prallel_grad_J(u,p,dt,comm):
    ...
    pproblem = simpleMpiVectorOCP(y0,yT,T,a,J,grad_J,parallel_J=parallel_J,prallel_grad_J=prallel_grad_J)
